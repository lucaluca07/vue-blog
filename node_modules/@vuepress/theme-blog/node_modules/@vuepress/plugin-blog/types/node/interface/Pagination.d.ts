...
export declare type PageFilter = (page: Page) => boolean;
export declare type PageSorter = (prev: Page, next: Page) => boolean | number;
export declare type GetPaginationPageUrl = (index: number) => string;
export declare type getPaginationPageTitle = (index: number) => string;
