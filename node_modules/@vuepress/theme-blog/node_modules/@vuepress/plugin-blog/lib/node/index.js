...
module.exports = (options, ctx) => {
    injectExtraAPI(ctx);
    const { pageEnhancers, frontmatterClassificationPages, extraPages, paginations, } = handleOptions_1.handleOptions(options, ctx);
    return {
                ...
                ...frontmatterClassificationPages
                    ...
                    return Object.keys(map).map(key => {
                        ...
                        paginations.push({
                            ...
                            ...util_1.resolvePaginationConfig(Classifier_1.ClassifierTypeEnum.Frontmatter, pagination, indexPath, ctx, keys),
                            pid: scope,
                            id: key,
                        });
                        return {
                            ...
                            id: key,
                            frontmatter: {
                                layout: Classifier_1.DefaultLayoutEnum.FrontmatterPagination,
                                title: `${key} ${scope}`,
                            },
                        };
                    });
